...
du5=pd.read_csv(path+'5.csv',header=-1)
du6=pd.read_csv(path+'6.csv',header=-1)
du7=pd.read_csv(path+'7.csv',header=-1)
du8=pd.read_csv(path+'8.csv',header=-1)
du9=pd.read_csv(path+'9.csv',header=-1)
du10=pd.read_csv(path+'10.csv',header=-1)
du11=pd.read_csv(path+'11.csv',header=-1)
